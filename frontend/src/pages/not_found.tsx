...
export function NotFound () {
    ...
    return (
        <main className="relative h-screen w-full">
            ...
            <div className="absolute inset-0 bg-[url('/not_found.svg')] opacity-85 z-10" />
            ...
            <div className="relative h-screen z-10 w-full flex justify-center items-center pl-32">
                <div className="flex flex-col pr-7 gap-y-8">
                    ...
                    <motion.h1 animate={ { translateX: [0, 50, 0] } } transition={ { duration: 4, repeat: Infinity, repeatType: "mirror" } } className="text-center text-[8rem] font-Fascinate text-[#D32F2F]">NOT FOUND</motion.h1>
                </div>
